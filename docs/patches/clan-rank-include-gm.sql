-- #clan-grade: RANK_KNIGHTS GM-dışlamasını gevşet — GM (Authority 0/250) clan puanına SAYILSIN,
-- banlı (255) yine dışlı. Test sunucusunda GM karakterin (test1) clan'ı grade alabilsin diye.
-- Orijinal: Authority NOT IN (0,250,255). Yeni: Authority NOT IN (255).
GO
ALTER PROCEDURE [RANK_KNIGHTS]
AS
